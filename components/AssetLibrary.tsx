      ...
      {mode === "chat" ? (
        ...
        <div style={{ display: "flex", flexDirection: "column", flex: 1, minHeight: 0 }}>
          <div style={{ flex: "none", padding: "12px 16px", borderBottom: "1px solid var(--stroke)", display: "flex", gap: 8 }}>
            ...
            <button onClick={() => alert("画布式生图正在接入，下一步上线。当前先用「对话式生图」：上传参考图 + 写提示词即可。")} title="画布式生图（下一步接入）" style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: 7, height: 38, borderRadius: 11, cursor: "pointer", fontSize: 12.5, fontWeight: 500, color: "var(--text-2)", background: "var(--panel)", border: "1px solid var(--stroke)" }}><Icon d={["M6 6m-2.5 0a2.5 2.5 0 1 0 5 0a2.5 2.5 0 1 0 -5 0", "M6 18m-2.5 0a2.5 2.5 0 1 0 5 0a2.5 2.5 0 1 0 -5 0", "M18 12m-2.5 0a2.5 2.5 0 1 0 5 0a2.5 2.5 0 1 0 -5 0", "M8.2 7 15.5 11M8.2 17 15.5 13"]} size={15} sw={1.7} />画布式生图</button>
          </div>
