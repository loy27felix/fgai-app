...
import type { CanvasNodeMetadata } from "@/reference/infinite-canvas/src/types/canvas";
import { getNodeSpec as getRegistryNodeSpec } from "@/reference/infinite-canvas/src/lib/canvas/node-registry";
