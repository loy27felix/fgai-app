...
import { NODE_SPECS } from "@/reference/infinite-canvas/src/constant/canvas";
import { registerNodeDefinitions } from "@/reference/infinite-canvas/src/lib/canvas/node-registry";
import { CanvasNodeType, type CanvasNodeData } from "@/reference/infinite-canvas/src/types/canvas";
import type { CanvasNodeDefinition, CanvasNodeResource } from "@/reference/infinite-canvas/src/types/canvas-plugin";
