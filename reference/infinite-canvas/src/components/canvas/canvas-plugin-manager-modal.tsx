...
import { installPluginFromUrl, setPluginEnabled, uninstallPlugin, updatePlugin } from "@/reference/infinite-canvas/src/lib/canvas/plugin-loader";
import { fetchOfficialPlugins, hasUpgrade, type OfficialPluginEntry } from "@/reference/infinite-canvas/src/lib/canvas/plugin-registry";
