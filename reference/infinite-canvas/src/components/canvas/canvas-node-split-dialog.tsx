...
import type { ImageSplitParams } from "@/reference/infinite-canvas/src/lib/canvas/canvas-image-data";
import { useImageEditorViewport } from "@/reference/infinite-canvas/src/components/canvas/use-image-editor-viewport";
