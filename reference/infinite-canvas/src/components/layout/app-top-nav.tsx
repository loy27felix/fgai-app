...
import { navigationTools, type NavigationToolSlug } from "@/reference/infinite-canvas/src/constant/navigation-tools";
import { AppConfigModal } from "@/reference/infinite-canvas/src/components/layout/app-config-modal";
import { MobileNavDrawer } from "@/reference/infinite-canvas/src/components/layout/mobile-nav-drawer";
