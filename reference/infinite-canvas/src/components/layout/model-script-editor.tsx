...
import { PLUGIN_RETURNS, PLUGIN_TEMPLATES, PLUGIN_VARIABLES } from "@/reference/infinite-canvas/src/services/api/model-plugin";
import type { ModelCapability } from "@/reference/infinite-canvas/src/stores/use-config-store";
