...
import type { CanvasConnection, CanvasNodeData, CanvasNodeMetadata } from "@/reference/infinite-canvas/src/types/canvas";
import type { CanvasResourceKind } from "@/reference/infinite-canvas/src/lib/canvas/canvas-resource-references";
