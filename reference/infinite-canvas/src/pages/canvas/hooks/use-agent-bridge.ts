...
import { applyCanvasAgentOps, type CanvasAgentOp, type CanvasAgentSnapshot } from "@/reference/infinite-canvas/src/lib/canvas/canvas-agent-ops";
import type { CanvasNodeGenerationMode } from "@/reference/infinite-canvas/src/components/canvas/canvas-node-prompt-panel";
import type { CanvasConnection, CanvasNodeData, ContextMenuState, ViewportTransform } from "@/reference/infinite-canvas/src/types/canvas";
