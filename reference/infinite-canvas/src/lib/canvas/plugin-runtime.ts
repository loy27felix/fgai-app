...
import { emitCanvasEvent, onCanvasEvent } from "@/reference/infinite-canvas/src/lib/canvas/canvas-event-bus";
import type { CanvasPluginApp } from "@/reference/infinite-canvas/src/types/canvas-plugin";
