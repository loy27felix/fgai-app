...
// The creator contract rejects references below 300KB. Keep the fixtures at
// the lower legal boundary while retaining only a tiny valid magic header.
const PNG = new Uint8Array(300_000);
PNG.set([0x89, 0x50, 0x4e, 0x47, 0x0d, 0x0a, 0x1a, 0x0a, 1]);
const JPEG = new Uint8Array(300_000);
JPEG.set([0xff, 0xd8, 0xff, 0xe0, 1]);
const WEBP = new Uint8Array(300_000);
WEBP.set([0x52, 0x49, 0x46, 0x46, 0x04, 0x00, 0x00, 0x00, 0x57, 0x45, 0x42, 0x50]);
